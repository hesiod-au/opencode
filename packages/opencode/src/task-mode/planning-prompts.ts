...
`
  ...
  export function buildAssessmentPrompt(planA: string, planB: string, sourceA: string, sourceB: string): string {
    return `You are a planning assessment agent. You have been given two independently generated analyses of the same work request. Your job is to evaluate both analyses, synthesize the best approach, and produce a final task table.
...
- **Dependencies are optional.** The default is \`-\` in the Deps column.
